...
class DetailsPage extends StatefulWidget {
  ...
  _DetailsPageState createState() =>
      _DetailsPageState(googlePlace: this.googlePlace, placeId: this.placeId);
}

class _DetailsPageState extends State<DetailsPage> {
  final String? _placeId;
  final GooglePlaces? _googlePlace;

  _DetailsPageState(
      {required String placeId, required GooglePlaces googlePlace})
      : _placeId = placeId,
  ...
  void getPhoto(String photoReference) async {
    var result = await _googlePlace?.photos.get(photoReference, 0, 400);
